...
Java is also necessary to be installed on your machine as DREAMM utilizes also [ProtDCal]( https://namishkhanna.github.io/newtab/?url=https://protdcal.zmb.uni-due.de/){:target="_blank"}, which is written in java, for feature extraction.

Lastly, you have to download [Uniclust30_2018_08_hhsuite]( https://namishkhanna.github.io/newtab/?url=http://wwwuser.gwdg.de/~compbiol/uniclust/2018_08/){:target="_blank" rel="noopener"} database, which is necessary to generate conservation scores (may take a while to download).
